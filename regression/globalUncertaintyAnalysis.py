...
# 1) save sensitivity files
"""

fission_rate = globalSensitivityAnalysis()
fission_rate.readFile_inputScalingFactors()
fission_rate.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "fission rate",
                                    deviation = 0.2, sample_number = 50)
...
resolution_rate.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "resolution rate",
                                        deviation = 0.1, sample_number = 50)
...
trapping_rate.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "trapping rate",
                                        deviation = 0.1, sample_number = 50)
...
diffusivity.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "diffusivity",
                                    deviation = 0.1, sample_number = 50)
...
nucleation_rate.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "nucleation rate",
                                    deviation = 0.1, sample_number = 50)
...
temperature.setValidationParameters(variable_name= "Intragranular gas swelling (/)", validation_name= "Baker", bias_name= "temperature",
                                    deviation = 0.2, sample_number = 50)
